...
describe("Test suite", function () {
    ...
    it("Enter incorrect bookmark name and verify error message is displayed", function () {
        HomePageModel.enterIncorrectTextInSearchField()

    })
    it("Fill the details in fields and do not click on send message button", function () {
